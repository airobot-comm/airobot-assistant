...
<img src=".agent/doc/assets/logo.webp" width="128" height="128" alt="AiRobot Logo" />
  ...
  <table style="width: 100%; border-collapse: collapse;">
    <tr>
      <td align="center" style="width: 33%;">
        <b>首页效果</b><br/>
        <img src=".agent/doc/design/home_page.png" width="100%" />
      </td>
      <td align="center" style="width: 33%;">
        <b>对话交互</b><br/>
        <img src=".agent/doc/design/speak_bubble.png" width="100%" />
      </td>
      <td align="center" style="width: 33%;">
        <b>功能卡片</b><br/>
        <img src=".agent/doc/design/function_card.png" width="100%" />
      </td>
    </tr>
  </table>
</div>
...
1. <img src=".agent/doc/design/system_auth.png" width="600" alt="系统认证信息" />
...
- [x] **v2.0: 架构升级 - 物理多模块化与本地端侧基础 (Completed)**
  - [x] 重构包名与项目架构，由单模块转向 `app` + `audio` + `agent` 多模块架构
  - [x] 将音频能力提取为独立库模块 `com.airobot.audio`
  - [x] 成功迁移 C++ JNI 逻辑与离线 AI 模型资源至 `audio` 模块
- [ ] **v2.1: 深度端侧 Agent 能力集成 (Planning)**
  - [ ] 引入 Rust 开发的端侧智能体模块 `agent`
  - [ ] 实现离线意图识别与复杂任务编排
...
- **[项目规则]**：[`./doc/rules.md`](.agent/rules/airobot-rules.md) - 项目 Vibe Code 执行规则与基础约定
- **[技术架构]**：[`./doc/architecture.md`](.agent/doc/architecture.md) - 项目代码架构与技术规范大纲
