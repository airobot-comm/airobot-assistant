...
1. <img src="docs/design/system_auth.png" width="600" alt="系统认证信息" />
...
- **[项目规则]**：[`./doc/rules.md`](docs/airobot-rules.md) - 项目 Vibe Code 执行规则与基础约定
- **[技术架构]**：[`./doc/architecture.md`](docs/architecture.md) - 项目代码架构与技术规范大纲
