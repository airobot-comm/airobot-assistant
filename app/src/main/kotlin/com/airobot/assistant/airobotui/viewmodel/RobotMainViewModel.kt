...
import com.airobot.assistant.system.SysState
import com.airobot.assistant.system.model.AiAgent
import com.airobot.assistant.system.model.DeviceInfo
import com.airobot.assistant.system.model.SystemInfo
import com.airobot.assistant.comm.NetCommService
import com.airobot.assistant.comm.NetworkState
            ...
            audioService.events.collect { event ->
                when (event) {
                    is AudioEvent.Wakeup -> {
                        ...
                        val isSystemReady = sysManage.state.value is com.airobot.assistant.system.SysState.Ready
